  ...
  return (
    <div className="flex flex-1 flex-col justify-self-center mb-5">
      ...
      <div className="mt-6 ml-4 flex justify-start gap-2.5">
        ...
        <h3 className="mt-2 ml-4 text-xl laedind-normaol font-semibold font-palanquin">{name}</h3>
        <p className="mt-2 ml-4 font-semibold font-montserrat text-coral-red leading-normal">{price}</p>
    </div>
  );
};
